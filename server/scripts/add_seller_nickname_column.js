...
(async () => {
  try {
    ...
    const [rows] = await db.query("SHOW COLUMNS FROM auctions LIKE 'seller_nickname'");
    ...
    await db.query("ALTER TABLE auctions ADD COLUMN seller_nickname VARCHAR(50) NULL");
